      ...
      {subStep === 2 && (
        <div className="w-full flex flex-col items-center gap-10">
          <div className="w-full flex flex-col items-start">
            <span className=""></span>
            <p className="text-xs font-medium text-[#8C9094]">لطفاً کد تأیید 6 رقمی را که به example@yahoo.com ارسال شده است را وارد کنید.مدت اعتبار این کد 30 دقیقه میباشد.</p>
