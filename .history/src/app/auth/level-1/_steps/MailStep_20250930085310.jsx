      ...
      {subStep === 3 && (
        <div className="w-full flex flex-col items-center gap-10">
            ...
            <div className="w-full flex flex-col items-center gap-3">
                <span className="w-full bg-sky-400/35 text-white border-solid border-[1px] border-sky-400 rounded-[15px] text-center py-3.5">example@yahoo.com</span>
                <span className="w-full text-start text-xs text-sky-400">ویرایش ایمیل</span>
            </div>
            </div>
          <button
            onClick={onNext}
