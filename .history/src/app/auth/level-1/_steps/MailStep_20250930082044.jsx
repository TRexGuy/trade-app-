        ...
        <div className="w-full flex flex-col items-center gap-10">
          ...
          <div className="w-full flex flex-col items-start gap-3">
            ...
            <div className="w-full grid grid-cols-6 gap-1.5">
                <input type="number" className="w-full outline-0 bg-black/65 text-xs text-[#73777A] placeholder:text-[#73777A] border-solid border-[3px] border-[#232329] rounded-xl p-4" />
            </div>
          </div>
          <button
