          ...
          <div className="w-full flex flex-col items-start gap-3">
            ...
            <div className="w-full grid grid-cols-6 gap-3">
              <input
                type="number"
                placeholder="_"
                className="w-full outline-0 text-center bg-black/65 text-xs text-[#73777A] placeholder:text-[#73777A] border-solid border-[3px] border-[#232329] rounded-xl p-2"
              />
              <input
                type="number"
                placeholder="_"
        ...
        <div className="w-full flex flex-col items-center gap-10">
          <div className="w-full flex flex-col items-start gap-4">
            ...
            <div className="w-full flex flex-col items-center gap-3">
              <span className="w-full bg-sky-400/35 text-white border-solid border-[1px] border-sky-400 rounded-[15px] text-center py-3.5">
                example@yahoo.com
              </span>
              <span onClick={handlePrevStep} className="w-full text-start text-xs text-sky-400">
                ویرایش ایمیل
              </span>
            </div>
          </div>
