      ...
      {subStep === 1 && (
        <div className="w-full flex flex-col items-center gap-10">
          ...
          <button
            ...
            className="w-full text-[16px] z-50 font-extrabold text-[#2A2C2E] bg-sky-400 rounded-[10px] text-center py-2.5"
          >
            تایید
          </button>
        </div>
      ...
      {subStep === 2 && (
        <div className="w-full flex flex-col items-center gap-10">
          <div className="w-full flex flex-col items-start">
            ...
            <button onClick={handlePrevStep} className="text-xs text-sky-400">ویرایش ایمیل</button>
          </div>
          <div className="w-full flex flex-col items-start gap-3">
            ...
            <div className="w-full grid grid-cols-6 gap-1.5">
              <input
                type="number"
                placeholder="_"
                className="w-full outline-0 bg-black/65 text-xs text-[#73777A] placeholder:text-[#73777A] border-solid border-[3px] border-[#232329] rounded-xl p-1"
              />
              <input
                type="number"
                placeholder="_"
