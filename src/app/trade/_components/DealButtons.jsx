...
export default function DealButtons() {
  return (
    <div className="w-full  border-2   border-[#31313a] bg-[#232329]  fixed bottom-0 right-0 left-0 flex items-center justify-between rounded-b-[30px] gap-7 py-3.5 px-7">
      <Link 
